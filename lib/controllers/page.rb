...
module Publish
  ...
  class Page_Controller < Plugin_Controller
    ...
    def text_asset_link_field
      Page_Select_Field.new(:name     => :page_id, 
    ...
    def update
      ...
      form[Content.tags] = Tag_Autocomplete_Field.new(:name  => Content.tags.to_s, 
                                                      :label => tl(:tags), 
                                                      :value => page.tags)
      ...
      page_form = render_form(form)
      
      return page_form unless param(:element) == 'app_main_content'
      
      Aurita::GUI::Page.new(:header => tl(:edit_page)) { page_form }
    end
